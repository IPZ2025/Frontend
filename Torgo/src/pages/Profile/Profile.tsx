...
const Profile = () => {
    ...
    const handleEditClick = () => {
        if (isEditing) {
            ...
            console.log('Sending data to server:', { 
                ...userData, 
                profileImage: profileImage ? 'base64image...' : null 
            });
    ...
    const hasChanges = () => {
        return userData.login !== originalData.login ||
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-center">
                                {profileImage ? (
                                    ...
                                    <div className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center text-2xl">
